_xamzrequire = function () {
        ...
        var n = e("../core"),
          ...
          o = {
            ...
            validateArnService: function (e) {
              var t = e._parsedArn;
              if ("s3" !== t.service && "s3-outposts" !== t.service && "s3-object-lambda" !== t.service) throw n.util.error(new Error, {
                code: "InvalidARN",
                message: "expect 's3' or 's3-outposts' or 's3-object-lambda' in ARN service component"
              })
            },
            validateArnAccount: function (e) {
              if (!/[0-9]{12}/.exec(e._parsedArn.accountId)) throw n.util.error(new Error, {
                code: "InvalidARN",
            ...
            validateS3AccessPointArn: function (e) {
              ...
              if (2 !== t.resource.split(r).length) throw n.util.error(new Error, {
                code: "InvalidARN",
                message: "Access Point ARN should have one resource accesspoint/{accesspointName}"
              });
              var i = t.resource.split(r)[1],
                s = i + "-" + t.accountId;
              if (!o.dnsCompatibleBucketName(s) || s.match(/\./)) throw n.util.error(new Error, {
                code: "InvalidARN",
            ...
            validateOutpostsArn: function (e) {
              var t = e._parsedArn;
              if (0 !== t.resource.indexOf("outpost:") && 0 !== t.resource.indexOf("outpost/")) throw n.util.error(new Error, {
                code: "InvalidARN",
                message: "ARN resource should begin with 'outpost/'"
              });
              var r = t.resource["outpost".length],
                i = t.resource.split(r)[1];
              if (!new RegExp(/^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9])$/).test(i)) throw n.util.error(new Error, {
                code: "InvalidARN",
            ...
            validateOutpostsAccessPointArn: function (e) {
              ...
              if (4 !== t.resource.split(r).length) throw n.util.error(new Error, {
                code: "InvalidARN",
            ...
            validateArnRegion: function (e) {
              var t = o.loadUseArnRegionConfig(e),
                r = e._parsedArn.region,
                s = e.service.config.region;
              if (!r) throw n.util.error(new Error, {
                code: "InvalidARN",
                message: "ARN region is empty"
              });
              if (s.indexOf("fips") >= 0 || r.indexOf("fips") >= 0) throw n.util.error(new Error, {
                code: "InvalidConfiguration",
                message: "ARN endpoint is not compatible with FIPS region"
              });
              if (!t && r !== s) throw n.util.error(new Error, {
                code: "InvalidConfiguration",
                message: "Configured region conflicts with access point region"
              });
              if (t && i.getEndpointSuffix(r) !== i.getEndpointSuffix(s)) throw n.util.error(new Error, {
                code: "InvalidConfiguration",
                message: "Configured region and access point region not in same partition"
              });
              if (e.service.config.useAccelerateEndpoint) throw n.util.error(new Error, {
                code: "InvalidConfiguration",
                message: "useAccelerateEndpoint config is not supported with access point ARN"
              });
              if ("s3-outposts" === e._parsedArn.service && e.service.config.useDualstack) throw n.util.error(new Error, {
                code: "InvalidConfiguration",
            ...
            loadUseArnRegionConfig: function (e) {
              ...
              if (void 0 !== s.s3UseArnRegion) o = !0 === s.s3UseArnRegion;
                ...
                if (r.env[t]) {
                  ...
                  if (["false", "true"].indexOf(a) < 0) throw n.util.error(new Error, {
                    code: "InvalidConfiguration",
                  ...
                  var u = {},
                    c = {};
                  try {
                    u = n.util.getProfilesFromSharedConfig(n.util.iniLoader), c = u[r.env.AWS_PROFILE || n.util.defaultProfile]
                  } catch (e) {}
                  if (c[i]) {
                    if (["false", "true"].indexOf(c[i].trim().toLowerCase()) < 0) throw n.util.error(new Error, {
                      code: "InvalidConfiguration",
            ...
            validatePopulateUriFromArn: function (e) {
              if (e.service._originalConfig && e.service._originalConfig.endpoint) throw n.util.error(new Error, {
                code: "InvalidConfiguration",
                message: "Custom endpoint is not compatible with access point ARN"
              });
              if (e.service.config.s3ForcePathStyle) throw n.util.error(new Error, {
                code: "InvalidConfiguration",
      ...
      i = {
        setupRequestListeners: function (e, t, r) {
          if (-1 !== r.indexOf(t.operation) && t.params.SourceRegion)
            if (t.params = n.util.copy(t.params), t.params.PreSignedUrl || t.params.SourceRegion === e.config.region) delete t.params.SourceRegion;
            else {
              var o = !!e.config.paramValidation;
              o && t.removeListener("validate", n.EventListeners.Core.VALIDATE_PARAMETERS), t.onAsync("validate", i.buildCrossRegionPresignedUrl), o && t.addListener("validate", n.EventListeners.Core.VALIDATE_PARAMETERS)
            }
        },
        buildCrossRegionPresignedUrl: function (e, t) {
          var r = n.util.copy(e.service.config);
          r.region = e.params.SourceRegion, delete e.params.SourceRegion, delete r.endpoint, delete r.params, r.signatureVersion = "v4";
        ...
        n.Service = s({
          ...
          apiAttemptEvent: function (e) {
            ...
            return n.httpResponse.statusCode && (r.HttpStatusCode = n.httpResponse.statusCode), !e._unAuthenticated && e.service.config.credentials && e.service.config.credentials.accessKeyId && (r.AccessKey = e.service.config.credentials.accessKeyId), n.httpResponse.headers ? (e.httpRequest.headers["x-amz-security-token"] && (r.SessionToken = e.httpRequest.headers["x-amz-security-token"]),
              n.httpResponse.headers["x-amzn-requestid"] && (r.XAmznRequestId = n.httpResponse.headers["x-amzn-requestid"]), n.httpResponse.headers["x-amz-request-id"] && (r.XAmzRequestId = n.httpResponse.headers["x-amz-request-id"]), n.httpResponse.headers["x-amz-id-2"] && (r.XAmzId2 = n.httpResponse.headers["x-amz-id-2"]), r) : r
          },
  ...
  65: [function (e, t, r) {
    function n(e, t) {
      ...
      delete t.serviceIdentifier, h(this, "isApi", !0, !1), h(this, "apiVersion", e.metadata.apiVersion), h(this, "endpointPrefix", e.metadata.endpointPrefix), h(this, "signingName", e.metadata.signingName), h(this, "globalEndpoint", e.metadata.globalEndpoint), h(this, "signatureVersion", e.metadata.signatureVersion), h(this, "jsonVersion", e.metadata.jsonVersion), h(this, "targetPrefix", e.metadata.targetPrefix), h(this, "protocol", e.metadata.protocol), h(this, "timestampFormat", e.metadata.timestampFormat), h(this, "xmlNamespaceUri", e.metadata.xmlNamespace), h(this, "abbreviation", e.metadata.serviceAbbreviation), h(this, "fullName", e.metadata.serviceFullName), h(this, "serviceId", e.metadata.serviceId), f && c[f] && h(this, "xmlNoDefaultLists", c[f].xmlNoDefaultLists, !1), p(this, "className", function () {
        ...
        return new o(e, r, t)
      }, l.string.lowerFirst, r)), h(this, "shapes", new i(e.shapes, t, function (e, r) {
        return s.create(r, t)
      })), h(this, "paginators", new i(e.paginators, t, function (e, r) {
        return new a(e, r, t)
      })), h(this, "waiters", new i(e.waiters, t, function (e, r) {
        return new u(e, r, t)
      }, l.string.lowerFirst)), t.documentation && (h(this, "documentation", e.documentation), h(this, "documentationUrl", e.documentationUrl))
    }
    var i = e("./collection"),
      o = e("./operation"),
      s = e("./shape"),
            ...
            if (e.service.api.operations) {
              ...
              if (t) {
                var r = e.httpRequest.body,
                  n = r && (i.util.Buffer.isBuffer(r) || "string" == typeof r),
                  o = e.httpRequest.headers;
                if (t.httpChecksumRequired && e.service.config.computeChecksums && n && e.service.getSignerClass(e) === i.Signers.V4 && !o["Content-MD5"]) {
                  var s = i.util.crypto.md5(r, "base64");
                  o["Content-MD5"] = s
                }
              }
            }
          ...
          if (o) {
            var s = function () {
              ...
              var h = e("util").inspect(l, !0, null),
                p = "";
              return u && (p += "[33m"), p += "[AWS " + n.service.serviceIdentifier + " " + c, p += " " + a.toString() + "s " + t.retryCount + " retries]", u && (p += "[0;1m"), p += " " + i.util.string.lowerFirst(n.operation), p += "(" + h + ")", u && (p += "[0m"), p
            }();
    ...
    (function (r) {
      (function () {
        ...
        function s(e) {
          ...
          if (!l || 1 !== l.length || "" !== l[0].Address)
            if (l && l.length > 0) e.httpRequest.updateEndpoint(l[0].Address);
              ...
              u(h), h.removeListener("validate", d.EventListeners.Core.VALIDATE_PARAMETERS), h.removeListener("retry", d.EventListeners.Core.RETRY_CHECK), d.endpointCache.put(c, [{
                Address: "",
        ...
        function a(e, t) {
          ...
          if (p && 1 === p.length && "" === p[0].Address) return g[h] || (g[h] = []), void g[h].push({
            request: e,
            callback: t
          });
          if (p && p.length > 0) e.httpRequest.updateEndpoint(p[0].Address), t();
            ...
            f.removeListener("validate", d.EventListeners.Core.VALIDATE_PARAMETERS), u(f), d.endpointCache.put(h, [{
              Address: "",
          ...
          ini: {
            parse: function (e) {
              ...
              return o.arrayEach(e.split(/\r?\n/), function (e) {
                ...
                var n = e.match(/^\s*\[([^\[\]]+)\]\s*$/);
                if (n) {
                  if ("__proto__" === (t = n[1]) || "__proto__" === t.split(/\s/)[1]) throw o.error(new Error("Cannot load profile name '" + t + "' from shared ini file."))
                } else if (t) {
    ...
    (function (t, n) {
      (function () {
        ...
        function u(e, t, n) {
          ...
          e.seen.push(t);
          var E;
          return E = y ? h(e, t, n, m, s) : s.map(function (r) {
        ...
        r.debuglog = function (e) {
          ...
          date: "magenta",
          regexp: "red"
        }, r.isArray = d, r.isBoolean = m, r.isNull = v, r.isNullOrUndefined = g, r.isNumber = y, r.isString = b, r.isSymbol = w, r.isUndefined = E, r.isRegExp = _, r.isObject = S, r.isDate = C, r.isError = x, r.isFunction = A, r.isPrimitive = R, r.isBuffer = e("./support/isBuffer");
  ...
  2: [function (e, t, r) {}, {}]
}, {}, [108, 112]), _xamzrequire = function e(t, r, n) {
  function i(s, a) {
    if (!r[s]) {
      if (!t[s]) {
  ...
  126: [function (e, t, r) {
    ...
    function s(e, t) {
      var r = {};
      return null === e ? r : (h.each(t.members, function (n, s) {
        if (s.isXmlAttribute) {
    ...
    n.prototype.parse = function (e, t) {
      ...
      try {
        if (window.DOMParser) {
          ...
          if (null === r.documentElement) throw h.error(new Error("Cannot parse empty document."), {
            code: "XMLParserError",
            retryable: !0
          });
          ...
          if (r = new window.ActiveXObject("Microsoft.XMLDOM"), r.async = !1, !r.loadXML(e)) throw h.error(new Error("Parse error in document"), {
            code: "XMLParserError",
            retryable: !0
          })
        }
      ...
      if (n) throw h.error(n || new Error, {
        code: "XMLParserError",
        retryable: !0
      });
      return {}
  ...
  32: [function (e, t, r) {
    ...
    var c = e("./browserHashUtils"),
      l = e("buffer/").Buffer,
      h = 64;
    t.exports = n, n.BLOCK_SIZE = h, n.prototype.update = function (e) {
    ...
    n.prototype.parse = function (e, t, r) {
      ...
      if (!S[i] && (s || i && !C[i])) {
        ...
        for (var c = 0; c < y.length; c++) {
          var l = n.indexOf(y[c]); - 1 !== l && (-1 === a || l < a) && (a = l)
      ...
      var z = n.indexOf("?");
      if (-1 !== z ? (this.search = n.substr(z), this.query = n.substr(z + 1), t && (this.query = x.parse(this.query)), n = n.slice(0, z)) : t && (this.search = "", this.query = {}), n && (this.pathname = n), C[o] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
        var D = this.pathname || "",
          U = this.search || "";
        this.path = D + U
      }
      ...
      return p = p || r.host && d.length, p && !E && d.unshift(""), d.length ? r.pathname = d.join("/") : (r.pathname = null, r.path = null), l(r.pathname) && l(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r
  ...
  13: [function (e, t, r) {
    ...
    t.exports = function (e, t, r, i) {
      ...
      a > 0 && u > a && (u = a);
      for (var c = 0; c < u; ++c) {
        var l, h, p, f, d = e[c].replace(s, "%20"),
          m = d.indexOf(r);
  ...
  10: [function (e, t, r) {
    ...
    t.exports = function (e, t, r, o) {
      ...
      u > 0 && c > u && (c = u);
      for (var l = 0; l < c; ++l) {
        var h, p, f, d, m = e[l].replace(a, "%20"),
          v = m.indexOf(r);
      ...
      (function () {
        ! function (n) {
          ...
          function p(e) {
            ...
            for (o = r > 0 ? r + 1 : 0; o < v;) {
              for (s = g, a = 1, l = _; o >= v && i("invalid-input"), p = c(e.charCodeAt(o++)), (p >= _ || p > N((E - g) / a)) && i("overflow"), g += p * a, f = l <= b ? S : l >= b + C ? C : l - b, !(p < f); l += _) d = _ - f, a > N(E / d) && i("overflow"), a *= d;
              t = m.length + 1, b = h(g - s, t, 0 == s), N(g / t) > E - y && i("overflow"), y += N(g / t), g %= t, m.splice(g++, 0, y)
            }
            return u(m)
          }
            ...
            for (n = o = w.length, o && w.push(k); n < v;) {
              ...
              for (g = n + 1, c - t > N((E - r) / g) && i("overflow"), r += (c - t) * g, t = c, u = 0; u < v; ++u)
                if (m = e[u], m < t && ++r > E && i("overflow"), m == t) {
                  for (p = r, f = _; d = f <= s ? S : f >= s + C ? C : f - s, !(p < d); f += _) b = p - d, y = _ - d, w.push(U(l(d + b % y, 0))), p = N(b / y);
  ...
  5: [function (e, t, r) {
    r.read = function (e, t, r, n, i) {
      ...
      var s, a, u, c = 8 * o - i - 1,
        ...
        d = n ? 1 : -1,
        m = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
      for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, s = l) : (s = Math.floor(Math.log(t) / Math.LN2), t * (u = Math.pow(2, -s)) < 1 && (s--, u *= 2), t += s + h >= 1 ? p / u : p * Math.pow(2, 1 - h), t * u >= 2 && (s++, u /= 2), s + h >= l ? (a = 0, s = l) : s + h >= 1 ? (a = (t * u - 1) * Math.pow(2, i), s += h) : (a = t * Math.pow(2, h - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + f] = 255 & a, f += d, a /= 256, i -= 8);
  ...
  1: [function (e, t, r) {
    ...
    function s(e) {
      var t, r, i = n(e),
        ...
        c = 0,
        l = a > 0 ? s - 4 : s;
      for (r = 0; r < l; r += 4) t = h[e.charCodeAt(r)] << 18 | h[e.charCodeAt(r + 1)] << 12 | h[e.charCodeAt(r + 2)] << 6 | h[e.charCodeAt(r + 3)], u[c++] = t >> 16 & 255, u[c++] = t >> 8 & 255, u[c++] = 255 & t;
      return 2 === a && (t = h[e.charCodeAt(r)] << 2 | h[e.charCodeAt(r + 1)] >> 4, u[c++] = 255 & t), 1 === a && (t = h[e.charCodeAt(r)] << 10 | h[e.charCodeAt(r + 1)] << 4 | h[e.charCodeAt(r + 2)] >> 2, u[c++] = t >> 8 & 255, u[c++] = 255 & t), u
    }
    ...
    for (var l = [], h = [], p = "undefined" != typeof Uint8Array ? Uint8Array : Array, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", d = 0, m = f.length; d < m; ++d) l[d] = f[d], h[f.charCodeAt(d)] = d;
  ...
  110: [function (e, t, r) {
    ...
    i.util.update(i.S3.prototype, {
      ...
      validateArnResourceType: function (e) {
        ...
        if (0 !== t.indexOf("accesspoint:") && 0 !== t.indexOf("accesspoint/")) throw i.util.error(new Error, {
          code: "InvalidARN",
      ...
      optInUsEast1RegionalEndpoint: function (e) {
        var t = e.service,
          r = t.config;
        if (r.s3UsEast1RegionalEndpoint = a(t._originalConfig, {
          ...
          regionalEndpoint = r.endpoint.substring(0, i) + ".us-east-1" + r.endpoint.substring(i), e.httpRequest.updateEndpoint(regionalEndpoint)
        }
      },
      ...
      populateUriFromAccessPointArn: function (e) {
        var t = e._parsedArn,
          ...
          u = !r && e.service.config.useDualstack ? ".dualstack" : "",
          c = e.httpRequest.endpoint,
          l = s.getEndpointSuffix(t.region),
          d = e.service.config.s3UseArnRegion;
        if (c.hostname = [t.accessPoint + "-" + t.accountId + a, o + u, d ? t.region : e.service.config.region, l].join("."), n) {
          var o = "s3-object-lambda",
            p = t.resource.split("/")[1];
          c.hostname = [p + "-" + t.accountId, o, d ? t.region : e.service.config.region, l].join(".")
        }
        c.host = c.hostname;
        var g = i.util.uriEscape(e.params.Bucket),
          f = e.httpRequest.path;
        e.httpRequest.path = f.replace(new RegExp("/" + g), ""), "/" !== e.httpRequest.path[0] && (e.httpRequest.path = "/" + e.httpRequest.path), e.httpRequest.region = t.region
      },
      ...
      willComputeChecksums: function (e) {
        var t = e.service.api.operations[e.operation].input.members,
          ...
          n = t.ContentMD5 && !e.params.ContentMD5 && r && (i.util.Buffer.isBuffer(e.httpRequest.body) || "string" == typeof e.httpRequest.body);
        return !(!n || !e.service.shouldDisableBodySigning(e) || e.isPresigned()) || !(!n || "s3" !== this.getSignatureVersion(e) || !e.isPresigned())
      },
      ...
      pathStyleBucketName: function (e) {
        return !!this.config.s3ForcePathStyle || !this.config.s3BucketEndpoint && (!o.dnsCompatibleBucketName(e) || !(!this.config.sslEnabled || !e.match(/\./)))
      },
      extractErrorFrom200Response: function (e) {
        if (u[e.request.operation]) {
          ...
          if (!t.body || !t.body.toString().match(/<[\w_]/)) throw e.data = null, i.util.error(new Error, {
            code: "InternalError",
      ...
      extractError: function (e) {
        ...
        if (t[n] && 0 === a.length) u && !s && (l = c[u] || null) !== r.httpRequest.region && (s = l), e.error = i.util.error(new Error, {
          ...
          d.Region && !s ? (s = d.Region, u && s !== c[u] && (c[u] = s)) : !u || s || d.Region || (l = c[u] || null) !== r.httpRequest.region && (s = l), e.error = i.util.error(new Error, {
            code: d.Code || n,
      ...
      requestBucketRegion: function (e, t) {
        ...
        if (!r || !a || r.region || "listObjects" === n.operation || i.util.isNode() && "headBucket" === n.operation || 400 === r.statusCode && "headObject" !== n.operation || -1 === c.indexOf(r.code)) return t();
        ...
        var u = n.service[o](s);
        u._requestRegionForBucket = a, u.send(function () {
      ...
      reqRegionForNetworkingError: function (e, t) {
        ...
        if (c && c !== n.httpRequest.region) s.updateReqBucketRegion(n, c), t();
          ...
          if (n.httpRequest.virtualHostedBucket) {
            ...
            s.updateReqBucketRegion(l, "us-east-1"), l._requestRegionForBucket = a, l.send(function () {
              var e = s.bucketRegionCache[a] || null;
              e && e !== n.httpRequest.region && s.updateReqBucketRegion(n, e), t()
            })
          } else t();
        else s.updateReqBucketRegion(n, "us-east-1"), "us-east-1" !== u[a] && (u[a] = "us-east-1"), t()
      },
      bucketRegionCache: {},
      ...
      preparePostFields: function (e, t, r, a, o, s) {
        ...
        var c = i.util.date.iso8601(u).replace(/[:\-]|\.\d{3}/g, ""),
          ...
          p = e.accessKeyId + "/" + d;
        a.bucket = r, a["X-Amz-Algorithm"] = "AWS4-HMAC-SHA256", a["X-Amz-Credential"] = p, a["X-Amz-Date"] = c, e.sessionToken && (a["X-Amz-Security-Token"] = e.sessionToken);
        for (var g in a)
      ...
      createBucket: function (e, t) {
        ...
        var r = this.endpoint.hostname,
          n = i.util.copy(e);
        return r === this.api.globalEndpoint || e.CreateBucketConfiguration || (n.CreateBucketConfiguration = {
      ...
      writeGetObjectResponse: function (e, t) {
        ...
        return n = -1 !== n.indexOf(this.config.region) ? n.replace("s3.", "s3-object-lambda.") : n.replace("s3.", "s3-object-lambda." + this.config.region + "."), r.httpRequest.endpoint = new i.Endpoint(n, this.config), r
      },
  ...
  87: [function (e, t, r) {
    ...
    i.S3.ManagedUpload = i.util.inherit({
      ...
      validateBody: function () {
        var e = this;
        if (e.body = e.service.config.params.Body, "string" == typeof e.body) e.body = i.util.buffer.toBuffer(e.body);
      ...
      bindServiceObject: function (e) {
        ...
        if (t.service) {
          ...
          n.signatureVersion = r.getSignatureVersion(), t.service = new r.constructor.__super__(n), t.service.config.params = i.util.merge(t.service.config.params || {}, e), Object.defineProperty(t.service, "_originalConfig", {
            get: function () {
...
AWS.apiLoader.services.s3["2006-03-01"] = {
  ...
  operations: {
    ...
    ProcessObject: {
      http: {
        method: "POST",
        requestUri: "/{Bucket}/{Key+}?x-zos-process",
        responseCode: 200
      },
      input: {
        type: "structure",
        required: ["Bucket","ProcessSource","Key","ZosProcess"],
        members: {
          "Bucket":{
          ...
          "ProcessSource":{
              "documentation":"<p>Specifies the source object for the post operation.</p>",
              "location":"header",
              "locationName":"x-zos-process-source"
          },
          "Key":{
          ...
          "ZosProcess":{
              "documentation":"<p>The parameter is used to process image.</p>",
              "locationName":"x-zos-process"
          }
        },
        "payload":"ZosProcess"
      }
  ...
  114: [function (e, n, i) {
    ...
    t.util.update(t.STS.prototype, {
      credentialsFrom: function (e, n) {
        return e ? (n || (n = new t.TemporaryCredentials), n.expired = !1, n.accessKeyId = e.Credentials.AccessKeyId, n.secretAccessKey = e.Credentials.SecretAccessKey, n.sessionToken = e.Credentials.SessionToken, n.expireTime = e.Credentials.Expiration, n) : null
      },
      ...
      optInRegionalEndpoint: function (e) {
        var n = e.service,
          i = n.config;
        if (i.stsRegionalEndpoints = r(n._originalConfig, {
          ...
          if (!i.region) throw t.util.error(new Error, {
            code: "ConfigError",
            message: "Missing region in config"
          });
